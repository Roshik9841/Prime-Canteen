...
<body>
    ...
    <div class="contact-container">
        ...
        <div class="contact-main-box">
            <div class="contact-box"><img src="images/location.png" style="width:80px; height:70px">
                <p class="contact-text1">Location</p>
                <p>khushibu,Nayabazar,Kathmandu</p>
            </div>
            <div class="contact-box"><img src="images/email.png" style="position: relative; bottom: 45px;">
                <p class="contact-text2">Email</p>
                <p style="bottom: 22px;">roshik9841@gmail.com</p>
            </div>
            <div class="contact-box"><img src="images/phone.png"
                    style="width:170px; height:150px; position: relative; bottom: 70px;">
        ...
        <div class="contact-form">
            ...
            <p>
                <label for="name">Message(Required)*</label><br>
                <textarea id="comments" name="comments" rows="6" cols="50" style="color:#E7E9E8;margin-bottom: 20px;"
